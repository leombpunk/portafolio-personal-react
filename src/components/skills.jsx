const Skills = () => {
        ...
        <div className='w-full h-full px-5 lg:px-10 py-5 text-balance flex flex-col gap-3 border-l-8 border-sky-300/50 bg-blue-900/45 rounded-md shadow-lg order-2'>
          <div className='grid grid-cols-3 md:grid-cols-5 gap-5'>
            ...
            <div className="group flex flex-col items-center justify-center gap-y-2">
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">JavaScript</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">ReactJS</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">AngularJS</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 400 400'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">TypeScript</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">HTML5</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">CSS3</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 32 32'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">TailwindCSS</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Bootstrap</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 32 32'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">jQuery</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">React Native</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
            ...
            <path d="M60.654 48.883c1.051-1.534 2.197-1.727 3.127-1.727s2.475.193 3.527 1.727C75.556 60.12 89.173 82.512 99.22 99.035c6.555 10.767 11.586 19.043 12.622 20.095 3.874 3.952 9.189 1.489 12.278-2.995 3.039-4.412 3.88-7.512 3.88-10.817 0-2.253-44.052-83.515-48.486-90.28C75.25 8.534 73.856 6.89 66.56 6.89h-5.469c-7.28 0-8.331 1.644-12.599 8.148C44.058 21.803 0 103.065 0 105.313c0 3.31.847 6.41 3.892 10.822 3.088 4.484 8.403 6.947 12.278 2.99 1.03-1.053 6.061-9.323 12.615-20.095 10.047-16.518 23.62-38.91 31.874-50.153z"></path>
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Expo</span>
            </div>
            ...
            <div className="group flex flex-col items-center justify-center gap-y-2">
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">PHP 8</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">NodeJS</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Express</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                width={80}
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">NestJS</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 32 32'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Java</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 32 32'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">SpringBoot</span>
            </div>
            <h3 className='col-span-3 md:col-span-5 text-2xl font-semibold text-center text-sky-300 pt-5 pb-3 border-t border-sky-300/50'>
              Databases
            </h3>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">MySQL</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 32 32'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">MariaDB</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                fill='#000000'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">SQL Server</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">MongoDB</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
    width={80}
  ...
  >
    ...
    />
    <path
      d="M22.554 3.867H5.623a1.52 1.52 0 0 0-1.516 1.516v17.962a42 42 0 0 1 13.569-2.684 123.6 123.6 0 0 1 4.878-16.794"
      style={{
        fill: "url(#a)",
      }}
    />
    ...
    />
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">SQLite</span>
            </div>
            <h3 className='col-span-3 md:col-span-5 text-2xl font-semibold text-center text-sky-300 pt-5 pb-3 border-t border-sky-300/50'>
              Otras herramientas
            </h3>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Git</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 20 20'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">GitHub</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 16 16'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Docker</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Firebase</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Cloudinary</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 256 256'
              ...
              <span className="text-lg text-center opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Visual Studio</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 32 32'
              ...
              <span className="text-lg text-center opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">VS Code</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='-1 0 258 258'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">XAMPP</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Asana</span>
            </div>
            <div className="group flex flex-col items-center justify-center gap-y-2">
              <svg
                viewBox='0 0 256 256'
              ...
              <span className="text-lg opacity-100 lg:opacity-0 group-hover:opacity-100 duration-500">Postman</span>
            </div>
          </div>
        </div>
      </section>
